...
export async function exchangeAuthorizationCodeForToken(code, region) {
  ...
  let tokenUrl = 'https://eu-app.contentstack.com/apps-api/apps/token';
  if(region==="EU")
  {
    tokenUrl = "https://eu-app.contentstack.com/apps-api/apps/token";
  }
  else if(region==="NA")
  {
    tokenUrl = "https://app.contentstack.com/apps-api/apps/token"
  }
  else if(region==="AZURE_NA")
  {
    tokenUrl = "https://azure-na-app.contentstack.com/apps-api/apps/token"
  }
  else if(region==="AZURE_EU")
  {
    tokenUrl = "https://azure-eu-app.contentstack.com/apps-api/apps/token"
  }
  else if(region==="GCP_NA")
  {
    tokenUrl = "https://gcp-na-app.contentstack.com/apps-api/apps/token"
  }
